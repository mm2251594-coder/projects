...
const eventsData = [
    {
        ...
        image: "https://i.pinimg.com/736x/53/3d/b3/533db3a193581bd0f59330724f4409c5.jpg",
        featured: true,
    ...
    },
    {
        ...
        image: "https://i.pinimg.com/1200x/3b/aa/36/3baa368a5d1098ea6b21dbb558ad64ec.jpg",
        featured: true,
    ...
    },
    {
        ...
        image: "https://i.pinimg.com/1200x/23/c0/9a/23c09a4a4c42bb008da5f4a266e55bb4.jpg",
        featured: false,
    ...
    },
    {
        ...
        image: "https://i.pinimg.com/736x/b5/bb/72/b5bb726141dcc79406baa60f9f0b5d34.jpg",
        featured: false,
...
// صور الالفعاليات
// صور الفعاليات حسب الـ ID
const locationImages = {
    1: "images/locations/موسيقى.jpg", // مهرجان الموسيقى السنوي
    2: "https://i.pinimg.com/736x/bd/24/03/bd24035372d7fcadc586629479c4cfc6.jpg", // معرض الفنون التشكيلية
    3: "https://images.unsplash.com/photo-1563089145-599997674d42?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=8", // حفل موسيقى الجاز الليلي
    4: "https://images.unsplash.com/photo-1546519638-68e109498ffc?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80", // بطولة كرة السلة للشباب
    5: "https://images.stockcake.com/public/7/e/5/7e59b229-0f1f-4a65-b6fd-04caa5dcd205_large/chefs-preparing-food-stockcake.jpg", // مهرجان المأكولات الشامية
    6: "https://images.unsplash.com/photo-1552674605-db6ffd4facb5?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80", // ماراثون دمشق الخيري
    7: "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80", // معرض الكتاب المستعمل
    8: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80", // مهرجان القهوة السورية
    9: "https://images.unsplash.com/photo-1563089145-599997674d42?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80", // معرض الحرف اليدوية
    10: "https://images.unsplash.com/photo-1532012197267-da84d127e765?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80" // ندوة الأدب السوري المعاصر
};
...
// وظيفة إدارة القائمة في الجوال
// وظيفة إدارة القائمة في الجوال - محدثة
function setupMobileMenu() {
    ...
    if (navbarToggler && navbarCollapse) {
        navbarToggler.addEventListener('click', function() {
            ...
            // تحديث حالة الزر للوصول الإلكتروني
...
function setLanguage(lang) {
    // وضع علامة أن المستخدم قام بتغيير اللغة
    sessionStorage.setItem('userChangedLanguage', 'true');
...
function showLanguageNotification(lang) {
    // عرض الإشعار فقط إذا كان التغيير من المستخدم
    const userChangedLanguage = sessionStorage.getItem('userChangedLanguage');
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            notification.remove();
            // مسح العلامة بعد عرض الإشعار
            sessionStorage.removeItem('userChangedLanguage');
        }, 300);
    }, 2000);
}
...
function initializeLanguage() {
    ...
    // التأكد من مسح أي علامات سابقة عند تهيئة الصفحة
    sessionStorage.removeItem('userChangedLanguage');
}
